...
export const Header: React.FC<HeaderProps> = ({ onToggleSidebar }) => {
  const { user, logout, currentHospitalId } = useAuth();
      ...
      <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="p-2 text-slate-500 hover:text-slate-700 bg-white hover:bg-slate-50 border border-slate-200/80 rounded-xl transition shadow-2xs cursor-pointer"
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2 text-slate-600 hover:text-slate-900 bg-white hover:bg-slate-50 border border-slate-200/80 rounded-xl transition shadow-2xs cursor-pointer"
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl border border-slate-200/80 bg-white hover:bg-slate-50 transition shadow-2xs text-left cursor-pointer"
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3.5 py-2 text-xs text-rose-600 hover:bg-rose-50 font-bold transition-colors cursor-pointer text-left"
                >
